...
| Hero — Mentor Recruitment | Poster Gallery | Program Schedule |
|:-:|:-:|:-:|
| ![Forward with Her hero: cream-toned landing page with animated 3D can on left and "Winter 2024 Mentor Recruitment" headline plus Join Us CTA on right](docs/showcase/hero.webp) | ![Gallery section: 3D can rotated to show side label, auto-scrolling horizontal strip of recruitment posters for women in STEM](docs/showcase/gallery.webp) | ![Program Schedule: 3D can showing "2024 WINTER" front label, three orange-accented steps — Preparation, Group Q&A, and One-on-One Sessions](docs/showcase/schedule.webp) |

| Application Requirements | Mobile |
|:-:|:-:|
| ![Application Requirements: 3D can viewed from behind, four mentor criteria listed plus Contact Us section with email and WeChat handle](docs/showcase/requirements.webp) | ![Mobile view: full-screen 3D can with "Forward with Her" branding and "2024 WINTER Mentee Recruitment" label — no scrolling required](docs/showcase/mobile-hero.webp) |

### Demo

![Forward with Her demo: page loads with animated 3D can, then scrolls through all four sections — Introduction, Gallery, Schedule, Requirements — while the can rotates to a new orientation in each section](docs/showcase/demo.gif)
<!-- SHOWCASE:END -->
